...
1. On the **Custom deployment** blade, click on the **Build your own template in the editor** option.

1. On the **Edit template** blade, click on **Load file**, locate the **C:\\AllFiles\\AZ500-AzureSecurityTechnologies-prod\\Allfiles\\Labs\04\\az-500-04_azuredeploy.json** file and click on **Open**.

    >**Note**: Review the content of the template and note that it deploys an Azure VM hosting Windows Server 2019 Datacenter.

1. On the **Edit template** blade, click on **Save**.

1. Back on the **Custom deployment** blade, click on **Edit parameters**.

1. On the **Edit parameters** blade, click on **Load file**, locate the **C:\\AllFiles\\AZ500-AzureSecurityTechnologies-prod\\Allfiles\\Labs\04\\az-500-04_azuredeploy.parameters.json** file and click on **Open**.

    >**Note**: Review the content of the parameters file noting the adminUsername and adminPassword values.

1. On the **Edit parameters** blade, click on **Save**.
...
1. On the blade displaying **Overview** of your current Azure AD tenant, click on **Manage tenants**, and then on the next screen, click on **+ Create**.

1. On the **Basics** tab of the **Create a tenant** blade, ensure that the option **Azure Active Directory** is selected and click on **Next: Configuration >**.
...
1. Add Captcha code on **Help us prove you're not a robot** blade and then click on **Submit** button.
...
1. On the **Licenses \| Overview** blade, in the **Manage** section, click on **All products** and then click on **+ Try / Buy**.
...
1. On **Create new user** blade, under **Properties** tab   specify Usage Location as **United States** and  click on **Next:Assignments>**. 
...
1. On **Create new user** blade, under **Properties** tab, specify Usage Location as **United States**.
...
1. Navigate back to the **AdatumLab500-04** Azure Active Directory blade and, from left navigation pane under the **Manage** section, click on **Licenses**.

1. On the **Licenses \| Overview** blade, from left navigation pane click on **All products**, select the **Azure Active Directory Premium P2** checkbox, and click on **+ Assign**.
...
1. Sign out from the Azure portal and sign back in using the same account. This step is necessary for the license assignment to take effect.
...
1. On the **multi-factor authentication** page, click on the **service settings (1)** tab. Review **verification options (2)**. Note that **Text message to phone**, **Notification through mobile app**, and **Verification code from mobile app or hardware token** are enabled. Click on **Save** and then click on **close**.
...
1. Click on **aaduser1 (2)** entry, then click on the **Enable (3)** link on the right-side, and, when prompted, click on **enable multi-factor auth**.
...
1. From left navigation pane under **Settings** section, click on **Fraud alert**.
...
1. Navigate back to the **AdatumLab500-04** Azure Active Directory tenant blade, in the **Manage** section, click on **Properties**, next click on the **Manage Security defaults** link at the bottom of the blade,

1. On the **Security Defaults** blade, click on **Disable**, select **My Organization is using Conditonal Access** as the reason and and then click on **Save**.
...
1. On the **Conditional Access \| Overview** blade, from left navigation pane select **Policies** click on the ellipsis next to **AZ500Policy1**, click on **Delete**, and, when prompted to confirm, click on **Yes**.
...
1. On the **Security \| Getting started** blade, from left navigation pane under **Protect** section, click on **Identity Protection**.
...
1. Enter the following username and password. Then select **OK**.
